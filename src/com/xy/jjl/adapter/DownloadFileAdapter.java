...
public class DownloadFileAdapter extends BaseAdapter implements OnRetryableFileDownloadStatusListener {

    *//**
     * LOG TAG
     *//*
    private static final String TAG = DownloadFileAdapter.class.getSimpleName();
    ...
    public DownloadFileAdapter(Activity activity) {
        super();
    ...
    *//**
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        LinearLayout lnlyDownloadItem = (LinearLayout) cacheConvertView.findViewById(R.id.DownloadItem);
